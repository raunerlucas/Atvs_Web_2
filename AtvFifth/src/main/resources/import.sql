...
insert into pessoa_juridica (id, nome, cnpj, telefone) VALUES (2, 'Empresa ABC LTDA', '12.345.678/0001-90','+5563988888888');

insert into pessoa_fisica (id, cpf, nome, telefone) VALUES (3, '987.654.321-00', 'Ciclano Oliveira','+5563977777777');
insert into pessoa_juridica (id, cnpj, nome, telefone) VALUES (4, '98.765.432/0001-21', 'Comércio XYZ S/A','+556396666666666');

insert into venda (data, pessoa_id) values ('2024-03-08',1);
insert into venda (data, pessoa_id) values ('2024-03-08',3);
insert into venda (data, pessoa_id) values ('2024-03-08',4);
insert into venda (data, pessoa_id) values ('2024-03-08',5);
insert into venda (data, pessoa_id) values ('2024-03-08',6);
insert into venda (data, pessoa_id) values ('2024-03-08',7);
insert into venda (data, pessoa_id) values ('2024-03-08',8);
